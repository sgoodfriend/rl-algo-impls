...
\begin{table}[t]
    ...
    \arrayrulecolor{black}\specialrule{.5pt}{0pt}{0pt}
    Mayari (2021 winner) & - & \colcell{53} & \colcell{32} & \colcell{73} & \colcell{88} & \colcell{75} & \colcell{82} \\
    2L (baseline) & \colcell{51} & - & \colcell{39} & \colcell{50} & \colcell{75} & \colcell{88} & \colcell{76} \\
    \textbf{\agentName} (2023 winner) & \colcell{62} & \colcell{59} & - & \colcell{49}\tnote{b} & \colcell{64} & \colcell{78} & \colcell{72} \\
    ObiBotKenobi (2023 2\textsuperscript{nd} place) & \colcell{39} & \colcell{29} & \colcell{47} & - & \colcell{58} & \colcell{65} & \colcell{66} \\
    POLightRush (baseline) & \colcell{0} & \colcell{25} & \colcell{29} & \colcell{38} & - & \colcell{69} & \colcell{55} \\
    POWorkerRush (baseline) & \colcell{13} & \colcell{13} & \colcell{21} & \colcell{29} & \colcell{38} & - & \colcell{53} \\
    \arrayrulecolor{black}\specialrule{.5pt}{0pt}{0pt}
    \end{tabular}
    \begin{tablenotes}
