...
\begin{table}[t]
    ...
    \caption{Single player round-robin benchmark win rates. Win rates above 50\% are bolded. (D) DoubleCone model used. (S) squnet model used.}
    ...
    BWDistantResources32x32 & \begin{tabular}[c]{@{}c@{}}\textbf{99} (D) \\ \textbf{93}
        ...
        \begin{tabular}[c]{@{}c@{}}\textbf{94}\tnote{b} (D) \\ \textbf{61} (S)\end{tabular} \\
